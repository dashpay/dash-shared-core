...
// #[no_mangle]
// pub unsafe extern "C" fn dash_spv_platform_document_contact_request_ContactRequestManager_stream_outgoing_contact_requests_with_contract2(
//     runtime: *mut std::os::raw::c_void,
//     self_: *mut dash_spv_platform::document::contact_request::ContactRequestManager,
//     user_id: *mut Arr_u8_32,
//     since: u64,
//     start_after: *mut crate::fermented::generics::Vec_u8,
//     contract: *mut crate::fermented::types::dpp::data_contract::dpp_data_contract_DataContract,
//     retry: *mut crate::fermented::types::dash_spv_platform::util::dash_spv_platform_util_RetryStrategy,
//     options: *mut crate::fermented::types::dash_spv_platform::document::contact_request::dash_spv_platform_document_contact_request_ContactRequestValidator,
//     delay: u64
// ) -> * mut crate::fermented::generics::Result_ok_Vec_dash_spv_platform_models_contact_request_ContactRequestKind_err_dash_spv_platform_error_Error {
//     let rt = unsafe { &*(runtime as *mut Runtime) };
//     println!("stream_outgoing_contact_requests_with_contract2: RT: {:?}", rt);
//     let obj = rt.block_on(async {
//         let manager = &*self_;
//         let user_id = <Arr_u8_32 as ferment::FFIConversionFrom<[u8; 32]>>::ffi_from(user_id);
//         let start_after = <crate::fermented::generics::Vec_u8 as ferment::FFIConversionFrom<Vec<u8>>>::ffi_from_opt(start_after);
//         let contract = <crate::fermented::types::dpp::data_contract::dpp_data_contract_DataContract as ferment::FFIConversionFrom<dpp::data_contract::DataContract>>::ffi_from(contract);
//         let retry = <crate::fermented::types::dash_spv_platform::util::dash_spv_platform_util_RetryStrategy as ferment::FFIConversionFrom<dash_spv_platform::util::RetryStrategy>>::ffi_from(retry);
//         let options = <crate::fermented::types::dash_spv_platform::document::contact_request::dash_spv_platform_document_contact_request_ContactRequestValidator as ferment::FFIConversionFrom<dash_spv_platform::document::contact_request::ContactRequestValidator>>::ffi_from(options);
//         println!("stream_outgoing_contact_requests_with_contract2 ARGS: {:?} {:?} {:?} {:?} {:?} {:?} {:?} {:?}", rt, manager, user_id, start_after, contract, retry, options, delay);
//         manager.stream_outgoing_contact_requests_with_contract(user_id, since, start_after, contract, retry, options, delay).await
//     });
//     println!("stream_outgoing_contact_requests_with_contract2: RESULT: {:?}", obj);
//     <crate::fermented::generics::Result_ok_Vec_dash_spv_platform_models_contact_request_ContactRequestKind_err_dash_spv_platform_error_Error as ferment::FFIConversionTo<Result<Vec<dash_spv_platform::models::contact_request::ContactRequestKind>, dash_spv_platform::error::Error>>>::ffi_to(obj)
// }
//
// #[no_mangle]
// pub unsafe extern "C" fn dash_spv_platform_document_contact_request_ContactRequestManager_stream_outgoing_contact_requests_with_contract3(
...
//     println!("stream_outgoing_contact_requests_with_contract3: RT: {:?}", rt);
//     let obj = rt.block_on(async {
//         let manager = &*self_;
//         let user_id = <Arr_u8_32 as ferment::FFIConversionFrom<[u8; 32]>>::ffi_from(user_id);
//         let start_after = <crate::fermented::generics::Vec_u8 as ferment::FFIConversionFrom<Vec<u8>>>::ffi_from_opt(start_after);
...
//         let retry = <crate::fermented::types::dash_spv_platform::util::dash_spv_platform_util_RetryStrategy as ferment::FFIConversionFrom<dash_spv_platform::util::RetryStrategy>>::ffi_from(retry);
//         let options = <crate::fermented::types::dash_spv_platform::document::contact_request::dash_spv_platform_document_contact_request_ContactRequestValidator as ferment::FFIConversionFrom<dash_spv_platform::document::contact_request::ContactRequestValidator>>::ffi_from(options);
//         println!("stream_outgoing_contact_requests_with_contract3: ARGS: {:?} {:?} {:?} {:?} {:?} {:?} {:?} {:?}", rt, manager, user_id, start_after, contract, retry, options, delay);
//         manager.stream_outgoing_contact_requests_with_contract(user_id, since, start_after, contract, retry, options, delay).await
//     });
//     println!("stream_outgoing_contact_requests_with_contract3: RESULT: {:?}", obj);
//     <crate::fermented::generics::Result_ok_Vec_dash_spv_platform_models_contact_request_ContactRequestKind_err_dash_spv_platform_error_Error as ferment::FFIConversionTo<Result<Vec<dash_spv_platform::models::contact_request::ContactRequestKind>, dash_spv_platform::error::Error>>>::ffi_to(obj)
// }
