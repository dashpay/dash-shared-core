...
pub unsafe extern "C" fn process_mnlistdiff_from_message(
    ...
    if !is_from_snapshot {
        ...
        if error != ProcessingError::None {
            ...
            return rs_ffi_interfaces::boxed(types::MNListDiffResult::default_with_error(error));
        }
    }
...
pub unsafe extern "C" fn process_qrinfo_from_message(
    ...
    let mut get_list_diff_result =
        |list_diff: models::MNListDiff, verify_quorums: bool| rs_ffi_interfaces::boxed(process_list_diff(list_diff, verify_quorums));
    ...
    if !is_from_snapshot {
        ...
        if error != ProcessingError::None {
            ...
            return rs_ffi_interfaces::boxed(types::QRInfoResult::default_with_error(error));
        }
    }
