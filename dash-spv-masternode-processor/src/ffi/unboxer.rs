...
//     let entry = unbox_any(x);
//     unbox_any_vec(unbox_vec_ptr(entry.values, entry.count));
// }
//
// /// # Safety
...
//     unbox_any_vec(unbox_vec_ptr(tx.inputs, tx.inputs_count));
//     unbox_any_vec(unbox_vec_ptr(tx.outputs, tx.outputs_count));
...
//         unbox_any(res.result_at_tip);
//     }
//     if !res.result_at_h.is_null() {
//         unbox_any(res.result_at_h);
//     }
//     if !res.result_at_h_c.is_null() {
//         unbox_any(res.result_at_h_c);
//     }
//     if !res.result_at_h_2c.is_null() {
//         unbox_any(res.result_at_h_2c);
//     }
//     if !res.result_at_h_3c.is_null() {
//         unbox_any(res.result_at_h_3c);
//     }
//     if !res.snapshot_at_h_c.is_null() {
//         unbox_any(res.snapshot_at_h_c);
//     }
//     if !res.snapshot_at_h_2c.is_null() {
//         unbox_any(res.snapshot_at_h_2c);
//     }
//     if !res.snapshot_at_h_3c.is_null() {
//         unbox_any(res.snapshot_at_h_3c);
//     }
//     if res.extra_share {
//         if !res.result_at_h_4c.is_null() {
//             unbox_any(res.result_at_h_4c);
//         }
//         if !res.snapshot_at_h_4c.is_null() {
//             unbox_any(res.snapshot_at_h_4c);
//         }
//     }
