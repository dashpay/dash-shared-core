...
fn test_bytes_reverse_comparison() {
    ...
    let mut vec = vec![
        <[u8; 32]>::from_hex("d2426992844e311149b2962f4ea991656ea5d1b36541e314e251915a6ffa1316").unwrap(),
        <[u8; 32]>::from_hex("30c14c1d75694404dbc96d44d1c63f28bf685d27e44ef753883c5eb0742c5805").unwrap(),
        <[u8; 32]>::from_hex("631a5e99e59bab2bf06e4ec9874b3c3ced59187dc724c689ffa0fe99f2d3f210").unwrap(),
        <[u8; 32]>::from_hex("113673823cf38eb56f30795d7f830b2d82b70a35b96812ad79d0889465b69df3").unwrap(),
        <[u8; 32]>::from_hex("0e01a796d779a8494be44311d6daf07fdae8642b45a9b866024cd97d8dfd3545").unwrap(),
        <[u8; 32]>::from_hex("feb146a52985cbf69f0a46b3a56f5f505538440bd42e993a0685a11fac1fdda5").unwrap(),
        <[u8; 32]>::from_hex("48d665ade991114900349635c788775204057220728212e2b6b63e3545f67007").unwrap(),
        <[u8; 32]>::from_hex("adcc454391d9f53e6fa523e047db5f335e38d9ead70dc8e4e648118c285d1d77").unwrap(),
        <[u8; 32]>::from_hex("aadd2eac24d6cc9a0b439d3c9d5483b0ed64ebda21786760bb375efacd6e2a67").unwrap(),
        <[u8; 32]>::from_hex("a90df0c30b2002a85cef6b695b986a3815c7dc82027c6896b7747258675a76da").unwrap(),
        <[u8; 32]>::from_hex("e13fbad0ab0bca68cbcd4d68127de06037b4007c5acbe8550edcd60b7d4503e8").unwrap(),
        <[u8; 32]>::from_hex("200ccffb2ef1da266efda63b35bc80bc8a547f29af3b8108f81ab222a1ceac35").unwrap(),
        <[u8; 32]>::from_hex("21173e00737bac467d09effb15959d0459b853160805057a3975436d3e206591").unwrap(),
        <[u8; 32]>::from_hex("321a1300b3ec63b3082d1626c7377d3c9e4e332eadefe12073f5e17b5099a49e").unwrap(),
    ];
...
fn test_any() {
    ...
    assert!(vec.iter().any(|node| *node == <[u8; 32]>::from_hex("30c14c1d75694404dbc96d44d1c63f28bf685d27e44ef753883c5eb0742c5805").unwrap()));
    assert!(!vec.iter().any(|node| *node == <[u8; 32]>::from_hex("ffc14c1d75694404dbc96d44d1c63f28bf685d27e44ef753883c5eb0742c5805").unwrap()));
}
