...
use dash_spv_crypto::crypto::{byte_util::Zeroable, UInt384};
...
fn test_legacy_basic_conversion() {
    ...
    let legacy_key = OperatorPublicKey {
        data: UInt384::from_hex("16ca29d03ef4897a22fe467bb58c52448c63bb29534502305e8ff142ac03907fae0851ff2528e4878ef51bfa3d5a1f22").unwrap().0,
        version: 1
    };
    let basic_key = OperatorPublicKey {
        data: UInt384::from_hex("96ca29d03ef4897a22fe467bb58c52448c63bb29534502305e8ff142ac03907fae0851ff2528e4878ef51bfa3d5a1f22").unwrap().0,
        version: 2,
    };
...
fn test_bls_migration() {
    ...
    match BLSKey::migrate_from_legacy_extended_public_key_data(&bytes) {
        Ok(key) => {
            ...
            assert_eq!(key.pubkey.to_hex(), "8bac7e5f4adc010f59973fc637cb7aed41ac52771a58c1f7c0978067be0ab44cf4b60d95ae9bdfe2e35d06f83cff7fbc");
            assert_eq!(key.chaincode.to_hex(), "99eb1756922d7c107de051561deb0104612b6e96d273606c4277d7700f5f5a38");
