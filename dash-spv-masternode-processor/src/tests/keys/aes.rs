...
fn test_bls_encryption_and_decryption() {
    ...
    let alice_address = address::with_public_key_data(&alice_public_key_data, chain.clone());
    assert_eq!(alice_public_key_data.to_lower_hex_string(), "1790635de8740e9a6a6b15fb6b72f3a16afa0973d971979b6ba54761d6e2502c50db76f4d26143f05459a42cfd520d44", "BLS publicKeyData is incorrect");
    ...
    assert_eq!(alice_private_key_data.to_lower_hex_string(), "46891c2cec49593c81921e473db7480029e0fc1eb933c6b93d81f5370eb19fbd", "BLS privateKeyData is incorrect");
    ...
    assert_eq!(bob_public_key_data.to_lower_hex_string(), "0e2f9055c17eb13221d8b41833468ab49f7d4e874ddf4b217f5126392a608fd48ccab3510548f1da4f397c1ad4f8e01a", "BLS publicKeyData is incorrect");
    ...
    assert_eq!(bob_private_key_data.to_lower_hex_string(), "2513a9d824e763f8b3ff4304c5d52d05154a82b4c975da965f124e5dcf915805", "BLS privateKeyData is incorrect");
    ...
    let encrypted = CryptoData::<BLSKey>::encrypt_with_secret_key_using_iv(&mut data, &alice_key_pair, &bob_key_pair, iv);
    ...
    let decrypted = CryptoData::<BLSKey>::decrypt_with_secret_key(&mut encrypted, &bob_key_pair, &alice_key_pair);
...
pub fn test_base64_extended_public_key_size() {
    ...
    let alice_key_pair = BLSKey::key_with_secret_hex("064b824c2c47493a3a123356688033fc12d2464dca59ebe9978c801d14a84b7c", true)
        .expect("BLSKey::key_with_secret_hex failed");
    ...
    let encrypted = CryptoData::<BLSKey>::encrypt_with_secret_key(&mut ext_pk_data, &alice_key_pair, &bob_key_pair).unwrap();
