...
pub fn test_core20_rc1_testnet() {
    ...
    let result = process_mnlistdiff(message_from_file("testnet/MNL_0_530000_70228.dat"), processor, &mut context, 70228, false, true);
    assert_diff_result(&mut context, result);
    let result = process_mnlistdiff(message_from_file("testnet/MNL_530000_904382__70230.dat"), processor, &mut context, 70230, false, true);
    assert_diff_result(&mut context, result);
    context.is_dip_0024 = true;
    let result = process_qrinfo(message_from_file("testnet/QRINFO_x3_y3__70230.dat"), processor, &mut context, 70230, false, true);
...
pub fn test_core20_activated_testnet() {
    ...
    let result = process_mnlistdiff(message_from_file("testnet/MNL_0_530000_70228.dat"), processor, &mut context, 70228, false, true);
    assert_diff_result(&mut context, result);
    let result = process_mnlistdiff(message_from_file("testnet/MNL_530000_905465__70230.dat"), processor, &mut context, 70230, false, true);
    assert_diff_result(&mut context, result);
    context.is_dip_0024 = true;
    let result = process_qrinfo(message_from_file("testnet/QRINFO_LAST.dat"), processor, &mut context, 70230, false, true);
    assert_qrinfo_result(&mut context, result);
}
...
struct QRInfoV20 {
    ...
    pub quorum_snapshot_at_hminus_c: crate::tests::json_from_core_snapshot::Snapshot,
    ...
    pub quorum_snapshot_at_hminus3c: crate::tests::json_from_core_snapshot::Snapshot,
    ...
    pub quorum_snapshot_list: Vec<crate::tests::json_from_core_snapshot::Snapshot>,
...
pub fn test_core_20_rc1_testnet_etalon() {
    let qrinfo_8792: QRInfoV20 = serde_json::from_slice(&message_from_file("testnet/qrinfo_530000_904144__70230.json")).unwrap();
    println!("qrinfo");
}
...
pub fn test_core20_rc2_testnet() {
    ...
    files.iter().for_each(|file_name| {
        let result = process_mnlistdiff(message_from_file(format!("testnet/{}", file_name).as_str()), processor, &mut context, 70230, false, true);
        assert_diff_result(&mut context, result);
    });
    context.is_dip_0024 = true;
    let result = process_qrinfo(message_from_file("testnet/QRINFO_x3_y3__70230.dat"), processor, &mut context, 70230, false, true);
