...
use crate::consensus::{Decodable, Encodable, encode, ReadExt, WriteExt};
...
impl Bitset {
    pub(crate) fn true_bits_count(&self) -> u64 {
    ...
    pub(crate) fn bit_is_true_at_le_index(&self, index: usize) -> bool {
