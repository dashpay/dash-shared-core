...
fn test_identity_funding_transaction_unique_id() {
    ...
    assert_eq!(is_lock.request_id().unwrap().to_byte_array().to_lower_hex_string(), UInt256::from_hex("7bab86a676ac6cd3ab0b8180f37121a36d8ae6fecea59e7c4e7783ce9cb84696").unwrap().reversed().0.to_lower_hex_string());
