...
pub mod types {
    pub mod models {
        pub mod input_value {
            #[doc = "FFI-representation of the # [doc = \"FFI-representation of the crate :: models :: input_value :: InputValue\"]"]
            #[repr(C)]
            #[derive(Clone)]
            ...
            impl ferment_interfaces::FFIConversion<crate::models::input_value::InputValue> for InputValue {
                unsafe fn ffi_from_const(
                    ffi: *const InputValue,
                ) -> crate::models::input_value::InputValue {
                    let ffi_ref = &*ffi;
                    crate::models::input_value::InputValue {
                        is_valid: ffi_ref.is_valid,
                        value: ffi_ref.value,
                    }
                }
                unsafe fn ffi_to_const(
                    obj: crate::models::input_value::InputValue,
                ) -> *const InputValue {
                    ferment_interfaces::boxed(InputValue {
                        is_valid: obj.is_valid,
                        value: obj.value,
                    })
                }
                unsafe fn destroy(ffi: *mut InputValue) {
                    ferment_interfaces::unbox_any(ffi);
                }
            }
            impl Drop for InputValue {
                fn drop(&mut self) {
                    unsafe {
                        let ffi_ref = self;
                    }
            ...
            #[no_mangle]
            pub unsafe extern "C" fn InputValue_ctor(
                is_valid: bool,
                value: u64,
            ) -> *mut InputValue {
                ferment_interfaces::boxed(InputValue { is_valid, value })
            }
            #[doc = r" # Safety"]
            #[allow(non_snake_case)]
            #[no_mangle]
            pub unsafe extern "C" fn InputValue_destroy(ffi: *mut InputValue) {
                ferment_interfaces::unbox_any(ffi);
            }
        }
    }
    pub mod messages {
        pub mod coinjoin_status_update {
            ...
            pub struct CoinJoinStatusUpdate {
                pub session_id: i32,
                pub pool_state: *mut crate::fermented::types::messages::pool_state::PoolState,
                pub status_update:
                    *mut crate::fermented::types::messages::pool_status_update::PoolStatusUpdate,
                pub message_id: *mut crate::fermented::types::messages::pool_message::PoolMessage,
            }
            impl
            ...
            pub unsafe extern "C" fn CoinJoinStatusUpdate_ctor(
                session_id: i32,
                pool_state: *mut crate::fermented::types::messages::pool_state::PoolState,
                status_update : * mut crate :: fermented :: types :: messages :: pool_status_update :: PoolStatusUpdate,
                message_id: *mut crate::fermented::types::messages::pool_message::PoolMessage,
        ...
        pub mod coinjoin_entry {
            ...
            #[derive(Clone)]
            #[allow(non_camel_case_types)]
            pub struct CoinJoinEntry { pub mixing_inputs : * mut crate :: fermented :: generics :: Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput , pub mixing_outputs : * mut crate :: fermented :: generics :: Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput , pub tx_collateral : * mut dash_spv_masternode_processor :: tx :: transaction :: Transaction , }
            ...
            pub unsafe extern "C" fn CoinJoinEntry_ctor(
                mixing_inputs : * mut crate :: fermented :: generics :: Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput,
                mixing_outputs : * mut crate :: fermented :: generics :: Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput,
        ...
        pub mod coinjoin_broadcast_tx {
            ...
            pub struct CoinJoinBroadcastTx {
                pub tx: *mut dash_spv_masternode_processor::tx::transaction::Transaction,
                pub pro_tx_hash: *mut dash_spv_masternode_processor::crypto::byte_util::UInt256,
                ...
                > for CoinJoinBroadcastTx
            {
                unsafe fn ffi_from_const(
                    ...
                    crate::messages::coinjoin_broadcast_tx::CoinJoinBroadcastTx {
                        ...
                        confirmed_height: ffi_ref.confirmed_height,
                    }
                }
                unsafe fn ffi_to_const(
                    ...
                    ferment_interfaces::boxed(CoinJoinBroadcastTx {
                        ...
                        confirmed_height: obj.confirmed_height,
                    })
                }
            ...
            pub unsafe extern "C" fn CoinJoinBroadcastTx_ctor(
                tx: *mut dash_spv_masternode_processor::tx::transaction::Transaction,
                pro_tx_hash: *mut dash_spv_masternode_processor::crypto::byte_util::UInt256,
        ...
        pub mod coinjoin_complete_message {
            ...
            pub struct CoinJoinCompleteMessage {
                ...
                pub msg_message_id:
                    *mut crate::fermented::types::messages::pool_message::PoolMessage,
            }
            impl
                ferment_interfaces::FFIConversion<
            ...
            pub unsafe extern "C" fn CoinJoinCompleteMessage_ctor(
                msg_session_id: i32,
                msg_message_id: *mut crate::fermented::types::messages::pool_message::PoolMessage,
        ...
        pub mod transaction_outpoint {
            ...
            pub struct TransactionOutPoint {
                pub hash: *mut dash_spv_masternode_processor::crypto::byte_util::UInt256,
                pub index: u32,
            }
            impl
                ferment_interfaces::FFIConversion<
            ...
            pub unsafe extern "C" fn TransactionOutPoint_ctor(
                hash: *mut dash_spv_masternode_processor::crypto::byte_util::UInt256,
                index: u32,
        ...
        pub mod coinjoin_signed_inputs {
            ...
            #[derive(Clone)]
            #[allow(non_camel_case_types)]
            pub struct CoinJoinSignedInputs { pub inputs : * mut crate :: fermented :: generics :: Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput , }
            impl
                ferment_interfaces::FFIConversion<
            ...
            pub unsafe extern "C" fn CoinJoinSignedInputs_ctor(
                inputs : * mut crate :: fermented :: generics :: Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput,
...
pub mod generics {
    ...
    #[derive(Clone)]
    #[allow(non_camel_case_types)]
    pub struct Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput { pub count : usize , pub values : * mut * mut crate :: fermented :: types :: dash_spv_masternode_processor :: tx :: transaction :: TransactionInput , }
    impl
        ferment_interfaces::FFIConversion<
            Vec<dash_spv_masternode_processor::tx::transaction::TransactionInput>,
        > for Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput
    {
        unsafe fn ffi_from_const(
            ffi: *const Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput,
        ) -> Vec<dash_spv_masternode_processor::tx::transaction::TransactionInput> {
            ferment_interfaces::FFIVecConversion::decode(&*ffi)
        }
        unsafe fn ffi_to_const(
            obj: Vec<dash_spv_masternode_processor::tx::transaction::TransactionInput>,
        ) -> *const Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput {
            ferment_interfaces::FFIVecConversion::encode(obj)
        }
        unsafe fn destroy(
            ffi: *mut Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput,
        ) {
            ferment_interfaces::unbox_any(ffi);
        }
    }
    impl ferment_interfaces::FFIVecConversion
        for Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput
    {
        type Value = Vec<dash_spv_masternode_processor::tx::transaction::TransactionInput>;
    ...
    impl Drop for Vec_dash_spv_masternode_processor_tx_transaction_TransactionInput {
        fn drop(&mut self) {
            unsafe {
    ...
    #[derive(Clone)]
    #[allow(non_camel_case_types)]
    pub struct Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput { pub count : usize , pub values : * mut * mut crate :: fermented :: types :: dash_spv_masternode_processor :: tx :: transaction :: TransactionOutput , }
    impl
        ferment_interfaces::FFIConversion<
            Vec<dash_spv_masternode_processor::tx::transaction::TransactionOutput>,
        > for Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput
    {
        unsafe fn ffi_from_const(
            ffi: *const Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput,
        ) -> Vec<dash_spv_masternode_processor::tx::transaction::TransactionOutput> {
            ferment_interfaces::FFIVecConversion::decode(&*ffi)
        }
        unsafe fn ffi_to_const(
            obj: Vec<dash_spv_masternode_processor::tx::transaction::TransactionOutput>,
        ) -> *const Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput {
            ferment_interfaces::FFIVecConversion::encode(obj)
        }
        unsafe fn destroy(
            ffi: *mut Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput,
        ) {
            ferment_interfaces::unbox_any(ffi);
        }
    }
    impl ferment_interfaces::FFIVecConversion
        for Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput
    {
        type Value = Vec<dash_spv_masternode_processor::tx::transaction::TransactionOutput>;
        unsafe fn decode(&self) -> Self::Value {
            ferment_interfaces::from_complex_vec(self.values, self.count)
        }
        unsafe fn encode(obj: Self::Value) -> *mut Self {
    ...
    impl Drop for Vec_dash_spv_masternode_processor_tx_transaction_TransactionOutput {
        fn drop(&mut self) {
            unsafe {
                ferment_interfaces::unbox_any_vec_ptr(self.values, self.count);
            }
